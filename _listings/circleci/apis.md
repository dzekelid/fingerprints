...
- name: CircleCI
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/fingerprint/master/_listings/circleci/project-username-project-checkout-key-fingerprint-delete.md
x-common:
- type: x-blog
