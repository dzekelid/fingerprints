...
- name: Google Cloud SQL API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/fingerprint/master/_listings/google-cloud-sql/projects-project-instances-instance-sslcerts-sha1fingerprint-get.md
x-common:
- type: x-change-log
