...
created: "2018-03-13"
modified: "2018-03-13"
url: https://raw.githubusercontent.com/streamdata-gallery/fingerprint/master/_listings/google-cloud-sql/apis.yaml
...
- name: Google Cloud SQL API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/fingerprint/master/_listings/google-cloud-sql/projects-project-instances-instance-sslcerts-sha1fingerprint-delete.md
x-common:
- type: x-change-log
